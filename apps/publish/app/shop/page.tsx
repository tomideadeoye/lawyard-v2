  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <div className="border-b border-border/40 py-6 px-6 sm:px-12">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] font-bold uppercase tracking-wider text-muted-foreground">
          ...
          <div className="flex items-center gap-6 text-foreground/80">
            <span className="normal-case font-medium text-xs text-muted-foreground/80">Showing 1–11 of 170 results</span>
