        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md p-4 animate-fade-in">
          <div className="glass premium-card max-w-lg w-full flex flex-col items-center gap-6 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full mt-4">
              <Link href="/directory/dashboard/add-listing" className="flex-1">
                <Button className="w-full glow-primary">
                  Configure Practice Listing
                </Button>
              </Link>
              <Link href="/directory/dashboard" className="flex-1">
            ...
            <CardContent className="space-y-4">
              {lawyer ? (
                ...
                <div className="text-center py-8 space-y-4">
                  ...
                  <Link href="/directory/dashboard/add-listing" className="inline-block mt-2">
