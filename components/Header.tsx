        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="flex-1 overflow-y-auto py-6 space-y-6 select-none">
            ...
            <nav className="flex flex-col gap-4 text-[10px] font-extrabold uppercase tracking-widest text-[#a77c5c]">
              <Link href="/tv" onClick={() => setMobileMenuOpen(false)} className="hover:opacity-85 transition-opacity no-underline">TV</Link>
              <Link href="/podcasts" onClick={() => setMobileMenuOpen(false)} className="hover:opacity-85 transition-opacity no-underline">Podcasts</Link>
              <Link href="/shop" onClick={() => setMobileMenuOpen(false)} className="hover:opacity-85 transition-opacity no-underline">Shop</Link>
              <Link href="/about" onClick={() => setMobileMenuOpen(false)} className="hover:opacity-85 transition-opacity no-underline">About</Link>
              <Link href="/contact" onClick={() => setMobileMenuOpen(false)} className="hover:opacity-85 transition-opacity no-underline">Contact</Link>
            </nav>
          </div>

          {/* Social footer */}
          <div className="pt-6 border-t border-border/10 flex items-center justify-between shrink-0">
